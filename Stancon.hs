...
We can easily see what Stan is generated by pretty-printing the data structure / program we just created:


FIXME: Tom - I am guessing this will generate the actual Stan inline
```haskell top hide
putStr $ ppStans linRegression
```
